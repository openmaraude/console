...
En confirmité avec le décret d'application, ce rayon est compris entre 100 et 500 mètres inclus.
Il est par défaut de la valeur maximum. Une fois changé, il n'est pas remis à la valeur par défaut
quand le chauffeur se reconnecte ou quand il est à nouveau disponible après une course.
...
Le chauffeur peut par exemple sur son application choisir rapidement un rayon parmi une liste de choix pour être
disponible en ligne.
