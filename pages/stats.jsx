  ...
  return (
    <>
      ...
      <Table>
        ...
        <TableRow>
          <TableCell>Nombre d’heures moyennes de connexion par jour par taxi ayant indiqué faire de la CPAM / de l’aéroport</TableCell>
          <TableCell></TableCell>
        </TableRow>
        <TableRow>
...
function StatsHails() {
  ...
  return (
    <>
      ...
      <Table>
        <TableRow>
          <TableCell/><TableCell>Par jour</TableCell><TableCell>Par semaine</TableCell><TableCell>Par mois</TableCell>
        </TableRow>
        <TableRow>
        ...
        <TableRow>
          <TableCell>Taux/Nombre de courses annulées par les chauffeurs (après acceptation client)</TableCell>
        ...
        <TableRow>
          <TableCell>Taux/Nombre de courses refusées par les chauffeurs (avant acceptation client)</TableCell>
